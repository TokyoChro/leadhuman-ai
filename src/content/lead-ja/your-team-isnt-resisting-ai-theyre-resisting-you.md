...
description: "社員がAIに抵抗するのは、テクノロジーを恐れているからではありません。AIを導入するリーダーが自分たちのことを本当に気にかけているかどうかを信じていないからです。研究が示すのは、能力の問題ではなく、認知される善意の問題です。"
pubDate: 2026-04-10
...
私が間近で見てきた停滞しているAI導入のほとんどは、テクノロジーとはほとんど関係ありません。
