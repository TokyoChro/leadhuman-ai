...
> 🔑 **会議は決定が下される場ではありません。合意形成を重視する文化では、会議は決定が確認される場です。本当の仕事は廊下で、コーヒーを飲みながら、一対一で行われています。** 会議の場でリアルタイムに人を説得しようとして入っていくなら、事前のすり合わせを重視する文化ではすでに負けています。
...
> 1️⃣ **何かを提案する前にステークホルダーをマッピングしましょう。** 影響を受ける人やサポートが必要な人を全員特定してください。日本の組織では、直接関係がなさそうに見える数階層離れた人も含まれることが多いです。彼らも含めましょう。

> 2️⃣ **まず個別に会話をしましょう。** 一人ひとりにプライベートにアイデアを共有してください。相手が言うことを注意深く聞き、さらに重要なのは言わないことに注目することです。これはロビー活動のツアーではなく、本当の意味での相談です。

> 3️⃣ **フィードバックを本当に取り入れましょう。** ここがほとんどの人が間違えるポイントです。根回しは、聞いたことに基づいて提案を再構築する意志がある場合にのみ機能します。形だけやっていると、人はそれを見抜きますし、覚えています。

> 4️⃣ **会議は、すでに合意されたことを確認する場にしましょう。** 提案が最終的にその場に届いたとき、ほとんど拍子抜けするくらいであるべきです。それがうまくいった証です。
